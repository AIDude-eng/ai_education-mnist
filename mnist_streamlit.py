...
st.sidebar.write("Gehe rechts die Aufgaben Schritt für Schritt durch. Wenn du auf die kleinen Kästchen drückst, "
                 "erscheint der nächste Bereich.")
...
st.write("### Wir werden nun gemeinsam Schritt für Schritt eine KI entwickeln. Genauer gesagt werden wir Maschinelles Lernen betreiben. "
         ...
         "handgeschriebene Zahlen zu klassifizieren. Das heißt wenn wir dem Computer ein Bild einer Zahl zeigen,"
...
st.write("### Wie wir gelernt haben, brauchen wir um eine KI zu trainieren, viele Daten. In unserem Fall brauchen wir "
         "viele Bilder von handgeschriebenen Zahlen. Glücklicherweise gibt es davon sehr viele Daten. "
...
load_data = st.checkbox(label="Daten laden")
...
if load_data:
    b1 = st.checkbox("Nächster Schritt: Daten abbilden")
